...
function HomePage() {
  ...
  const steps = [
    ...
    { icon: 'bi-house-door', title: 'Move In', desc: 'Get your booking confirmation and move into your new student home stress-free!', color: 'warning' },
  ]
    ...
    <>
        ...
        <div className="container">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              ...
              <p className="text-muted mb-0">Handpicked top-rated options for students</p>
            </div>
          ...
          <div className="row g-4 justify-content-center">
            {steps.map((step, idx) => (
              <div key={step.title} className="col-12 col-md-4 text-center">
                ...
                <div className={`badge bg-${step.color} rounded-pill mb-2`}>Step {idx + 1}</div>
                ...
                <div className="card h-100 border-0 shadow-sm p-4">
                  <div className="d-flex align-items-center mb-3 gap-3">
                    <div
                      ...
                      style={{ width: '48px', height: '48px', fontSize: '14px', flexShrink: 0 }}
                    >
                      {t.avatar}
                    </div>
                    <div>
      ...
      <section className="hero-gradient text-white py-5" id="about">
        <div className="container text-center">
          ...
          <p className="lead mb-4 opacity-90">List your property on Dormify and reach thousands of students!</p>
          <Link to="/register" className="btn btn-light btn-lg text-primary fw-bold px-5">
            List Your Property <i className="bi bi-arrow-right ms-2"></i>
          </Link>
        </div>
      </section>
